...
import {
  LayoutDashboard, Users, PlusCircle, ExternalLink, LogOut, TrendingUp
} from 'lucide-react'
    ...
    <aside style={{
      ...
      <div style={{ padding: '28px 20px 24px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <div style={{ width: 36, height: 36, borderRadius: 10, background: '#0F7A63', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 900, fontSize: 18, color: '#fff' }}>+</div>
          <div>
            <div style={{ fontWeight: 800, fontSize: 17, color: '#fff', lineHeight: 1 }}>DKV</div>
            <div style={{ fontSize: 10.5, color: 'rgba(255,255,255,0.45)', fontWeight: 500, marginTop: 2 }}>Panel de asesores</div>
          </div>
        </div>
      </div>
